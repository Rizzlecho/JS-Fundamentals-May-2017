const sharedObject = require('./sharedObj').sharedObject;
...
describe('sharedObject', function () {
    ...
    describe('changeName', function () {
        ...
        it('should return previous name for empty parameter', function () {
        ...
        it('should return new name after calling the function one more time', function () {
            sharedObject.changeName("Pesho");
